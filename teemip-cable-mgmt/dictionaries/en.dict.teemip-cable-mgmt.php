...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:NetworkSocket/Attribute:networksocket_id+' => 'Remote network socket connected to the network socket. This attribute cannot be filled at the same time as the Device or Cross connect ones',
	...
	'Class:NetworkSocket/Attribute:crossconnect_id+' => 'Cross Connect using the network socket. This attribute cannot be filled at the same time as the Device or Network socket ones',
