...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:NetworkSocket/Attribute:crossconnect_id+' => 'Cross Connect using the network socket.',
    ...
    'Class:NetworkSocket/Attribute:cabletype_id' => 'Cable type',
    'Class:NetworkSocket/Attribute:cabletype_id+' => 'Cable type to be used with the network socket',
    'Class:NetworkSocket/Attribute:cabletype_name' => 'Cable type name',
...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:PatchPanel/Attribute:free_sockets+' => 'Number of network sockets still available on the panel: not created yet, inactive or ready',
    ...
    'Class:PatchPanel/Attribute:cabletype_id' => 'Cable type',
    'Class:PatchPanel/Attribute:cabletype_id+' => 'Main cable type to be used with the patch panel',
    'Class:PatchPanel/Attribute:cabletype_name' => 'Cable type name',
...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:CrossConnect/Tab:cables_list' => 'Cables',
	'Class:CrossConnect/Tab:cables_list+' => 'List of all the cables that make the Cross Connects',
    ...
    'Class:CrossConnect/Attribute:connectableci_id' => 'Device',
    'Class:CrossConnect/Attribute:connectableci_id+' => 'Device connected to the local side of the Cross Connect',
    'Class:CrossConnect/Attribute:connectableci_name' => 'Device name',
    'Class:CrossConnect/Attribute:connectableci_name+' => '',
    'Class:CrossConnect/Attribute:physicalinterface_id' => 'Physical interface',
    ...
    'Class:CrossConnect/Attribute:physicalinterface_name' => 'Physical interface name',
    ...
    'Class:CrossConnect/Attribute:remote_connectableci_id' => 'Peer device',
    'Class:CrossConnect/Attribute:remote_connectableci_id+' => 'Device connected at the peer location of the Cross Connect',
    'Class:CrossConnect/Attribute:remote_connectableci_name' => 'Peer device name',
    'Class:CrossConnect/Attribute:remote_connectableci_name+' => '',
    'Class:CrossConnect/Attribute:remote_physicalinterface_id' => 'Peer physical interface',
    'Class:CrossConnect/Attribute:remote_physicalinterface_id+' => 'Physical interface through which the peer device is connected to the cross connect',
    'Class:CrossConnect/Attribute:remote_physicalinterface_name' => 'Peer physical interface name',
...
Dict::Add('EN US', 'English', 'English', array(
	...
	'UI:CableManagement:Action:Create:PatchPanel:CreateBackEndNetworkCables:Helper' => 'Select a remote patch panel and the number of cables to create',
	'UI:CableManagement:Action:Create:PatchPanel:CreateBackEndNetworkCables:Quantity' => 'Number',
	...
	'UI:CableManagement:Action:Create:PatchPanel:CreateBackEndNetworkCables:NoCreationRequested' => 'No creation of Back End cables have been requested!',
	...
	'UI:CableManagement:Action:Create:PatchPanel:CreateBackEndNetworkCables:NotEnoughCapacity' => 'Back End cables cannot be created: remote Patch Panel %1$s has less capacity (%2$s) than what is required (%3$s)!',
    ...
    'UI:CableManagement:Action:CreateOrUpdate:CrossConnect:FindWirings:NoPathFound' => 'No path has been found to connect the 2 patch panels!',
