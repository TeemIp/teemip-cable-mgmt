...
Dict::Add('DE DE', 'German', 'Deutsch', array(
	...
	'Class:NetworkSocket/Attribute:org_id+' => 'Die Organisation der Netzwerkdose ist die des Patch-Panels, wenn es ein solches gibt, ansonsten die des Standort.',
	...
	'Class:NetworkSocket/Attribute:crossconnect_id+' => 'Das Cross Connect geht über die Netzwerkbuchse.',
    ...
    'Class:NetworkSocket/Attribute:cabletype_id' => 'Kabel-Typ',
    'Class:NetworkSocket/Attribute:cabletype_id+' => 'Cable type to be used with the network socket',
    'Class:NetworkSocket/Attribute:cabletype_name' => 'Name Kabel-Typ',
...
Dict::Add('DE DE', 'German', 'Deutsch', array(
    ...
    'Class:PatchPanel/Attribute:cabletype_id' => 'Kabel-Typ',
    'Class:PatchPanel/Attribute:cabletype_id+' => 'Main cable type to be used with the patch panel',
    'Class:PatchPanel/Attribute:cabletype_name' => 'Name Kabel-Typ',
...
Dict::Add('DE DE', 'English', 'English', array(
	...
	'Class:CrossConnect/Tab:cables_list' => 'Kablen',
    ...
    'Class:CrossConnect/Attribute:remote_connectableci_name' => 'Name peer Gerät',
    'Class:CrossConnect/Attribute:remote_connectableci_name+' => '',
    'Class:CrossConnect/Attribute:remote_physicalinterface_id' => 'Peer physikalische Schnittstelle (Interface)',
    ...
    'Class:CrossConnect/Attribute:remote_physicalinterface_name' => 'Name peer physikalische Schnittstelle ',
...
Dict::Add('DE DE', 'German', 'Deutsch', array(
	...
	'UI:CableManagement:Action:Create:PatchPanel:CreateBackEndNetworkCables:Quantity' => 'Nummer',
	...
	'UI:CableManagement:Action:Create:PatchPanel:CreateBackEndNetworkCables:NoCreationRequested' => 'Es wurde keine Erstellung von Back-End-Kabeln beantragt!',
	...
	'UI:CableManagement:Action:Create:PatchPanel:CreateBackEndNetworkCables:NotEnoughCapacity' => 'Netzwerkkabel (Rückseite) können nicht erstellt werden: Kapazität (%2$s) des entfernten Patchpanels %1$s is niedriger als erforderlich (%3$s)!',
