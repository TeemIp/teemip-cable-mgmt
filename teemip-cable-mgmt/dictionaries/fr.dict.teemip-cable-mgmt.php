...
Dict::Add('FR FR', 'French', 'Français', array(
	'Class:IPConfig/Attribute:allow_backendnetworkcable_to_cross_orgs' => 'Autorise le câblage vers une autre organisation',
...
Dict::Add('FR FR', 'French', 'Français', array(
	...
	'Class:NetworkSocket/Attribute:org_id+' => 'L\'organisation de la prise est celle du patch panel s\'il y en a un, celle du lieu sinon.',
	...
	'Class:NetworkSocket/Attribute:crossconnect_id+' => 'Cross Connect utilisant la prise réseau.',
    ...
    'Class:NetworkSocket/Attribute:cabletype_id' => 'Type de câble',
    'Class:NetworkSocket/Attribute:cabletype_id+' => 'Type de câble à utiliser avec la prise réseau',
    'Class:NetworkSocket/Attribute:cabletype_name' => 'Nom du type de câble',
...
Dict::Add('FR FR', 'French', 'Français', array(
    ...
    'Class:PatchPanel/Attribute:cabletype_id' => 'Type de câble',
    'Class:PatchPanel/Attribute:cabletype_id+' => 'Type de câble à utiliser avec le panneau de brassage',
    'Class:PatchPanel/Attribute:cabletype_name' => 'Nom du type de câble',
...
Dict::Add('FR FR', 'English', 'English', array(
	...
	'Class:CrossConnect/Tab:cables_list' => 'Câbles',
	'Class:CrossConnect/Tab:cables_list+' => 'Liste de tous les câbles qui constituent le Cross Connect',
    ...
    'Class:CrossConnect/Attribute:connectableci_id' => 'Equipement',
    'Class:CrossConnect/Attribute:connectableci_id+' => 'Equipement connecté à l\'unité locale du cross connect',
    'Class:CrossConnect/Attribute:connectableci_name' => 'Nom de l\'équipement',
    'Class:CrossConnect/Attribute:connectableci_name+' => '',
    'Class:CrossConnect/Attribute:physicalinterface_id' => 'Interface physique',
    'Class:CrossConnect/Attribute:physicalinterface_id+' => 'Interface physique via laquelle l\'équipement est connecté au cross connect',
    'Class:CrossConnect/Attribute:physicalinterface_name' => 'Nom de l\'interface physique',
    ...
    'Class:CrossConnect/Attribute:remote_connectableci_id' => 'Equipement homologue',
    'Class:CrossConnect/Attribute:remote_connectableci_id+' => 'Equipement connecté à l\'unité homologue du cross connect',
    'Class:CrossConnect/Attribute:remote_connectableci_name' => 'Nom de l\'équipement homologue',
    'Class:CrossConnect/Attribute:remote_connectableci_name+' => '',
    'Class:CrossConnect/Attribute:remote_physicalinterface_id' => 'Interface physique homologue',
    'Class:CrossConnect/Attribute:remote_physicalinterface_id+' => 'Interface physique via laquelle l\'équipement homologue est connecté au cross connect',
    'Class:CrossConnect/Attribute:remote_physicalinterface_name' => 'Nom de l\'interface physique homologue',
